...
// set_contains
bool set_contains(const std::string& word, const XPtr<std::unordered_set<std::string>>& table);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const XPtr<std::unordered_set<std::string>>& >::type table(tableSEXP);
